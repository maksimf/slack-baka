    ...
    case TeamJoin(user: User) => responder ! PrivateResponse(
     // s"Hey ${user.name} and welcome to our community!",
      """Привет!
        ...
        |#community - ссылки на гайд, форму для приглашения друзей в конфу, обсуждения банов и реквесты смайлов
        ...
        |#tech - обсуждаем технологии: софт, железо, операционные системы.
